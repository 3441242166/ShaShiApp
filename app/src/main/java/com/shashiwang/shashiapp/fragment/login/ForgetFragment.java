...
public class ForgetFragment extends BaseFragment<ForgetPresenter> implements IForgetView {
    ...
    @Override
    protected ForgetPresenter setPresenter() {
        return new ForgetPresenter(this,getContext());
    }
